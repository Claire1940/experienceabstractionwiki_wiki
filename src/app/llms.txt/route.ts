...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://experienceabstractionwiki.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Experience Abstraction Wiki'
