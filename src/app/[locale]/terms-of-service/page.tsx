...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Read the Terms of Service for Experience Abstraction Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Experience Abstraction Wiki",
      description: "Terms and conditions for using Experience Abstraction Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Experience Abstraction Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Experience Abstraction Wiki (&quot;the Website&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;), you agree to be bound
              by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you (&quot;User&quot;, &quot;you&quot;, or &quot;your&quot;) and Experience Abstraction Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Experience Abstraction Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game &quot;Experience Abstraction&quot; (developed by pawlooz, inspired by
              The Amazing Digital Circus). Our services include, but are not limited to:
            </p>
            <ul>
              <li>Abstraction method guides and survival strategies</li>
              <li>Caine encounter and Cellar walkthroughs</li>
              <li>Character and abstracted-form information</li>
              <li>Map, room, and dark-location guides</li>
              <li>Update and new cutscene coverage</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Experience Abstraction Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation, the developer pawlooz, or Glitch Productions (creator of The Amazing Digital Circus).
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Experience Abstraction Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation, the developer pawlooz, and/or Glitch Productions
              (creator of The Amazing Digital Circus). We use such content under fair use principles for
            ...
            <ul>
              ...
              <li><strong>Game Changes:</strong> Experience Abstraction is actively updated by pawlooz. Game mechanics, abstraction methods, characters, and cutscenes may change without notice. We are not responsible for these changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, EXPERIENCE ABSTRACTION WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Roblox, Reddit, YouTube, social media platforms,
            ...
            <p>
              ...
              you and Experience Abstraction Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@experienceabstractionwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@experienceabstractionwiki.wiki</a>
            </p>
            <p>
