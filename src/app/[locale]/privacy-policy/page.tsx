...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Experience Abstraction Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Experience Abstraction Wiki (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Roblox, Reddit, YouTube, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Experience Abstraction Wiki is an unofficial, fan-made website and is not affiliated with, endorsed by, or associated
              with Roblox Corporation, the game&apos;s developer pawlooz, or Glitch Productions, the creator of
              The Amazing Digital Circus (TADC) which inspired the game. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@experienceabstractionwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@experienceabstractionwiki.wiki</a>
            </p>
            <p>
